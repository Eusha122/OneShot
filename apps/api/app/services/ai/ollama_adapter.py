...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "and $$...$$ for display). Never put spaces beside math delimiters: use $x=3$, not $ x=3 $. "
    "For chemistry equations, use display math with \\mathrm, for example "
    "$$\\mathrm{Al} + 3\\mathrm{HCl} \\rightarrow \\mathrm{AlCl}_{3} + 3\\mathrm{H}_{2}$$. "
    "Always refer to the interactive animation or graph displayed below "
